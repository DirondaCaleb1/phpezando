let formCategoryEdit = document.querySelector("#form_admin_addCategory");
let formEditAs = document.querySelector("#form_admin_editCategory");

if (formCategoryEdit === null && formEditAs !== null) {
  //Error Elements
  let errorElt = document.querySelector("#error-updateCategory");
  ...
  //TextAreas Elements
  let textareas = formEdit.querySelectorAll("textarea");
        ...
        if (
          ...
          if (
            ...
            return {
              ...
              elements: [nameCategory, meta_description, meta_titleCategory],
            };
          } else if (
            getErrors(
              nameCategoryValue,
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            return {
              message: "Veuillez obligatoirement remplir  les champs vides",
              //Le cham nom possède des caractères invalides (seules les lettres sont autorisées)
          ...
          if (
            ...
            return {
              message:
                "Les champs nom,slug et meta titre possèdent des caractères invalides (seules les lettres sont autorisées)",
              //Le cham nom possède des caractères invalides (seules les lettres sont autorisées) et l'image a une extension invalide (extensions autorisées .jpg .JPG, .jpeg, .JPEG, .png, .PNG)
              elements: [
                nameCategory,
                slugCategory,
  ...
  formEditAs.addEventListener("submit", (e) => {
    let nameCategoryValue = nameCategory.value;
    let slugCategoryValue = slugCategory.value;
    let imageCategoryValue = imageCategory.files[0];
    let meta_titleCategoryValue = meta_titleCategory.value;
